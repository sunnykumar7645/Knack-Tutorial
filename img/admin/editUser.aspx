<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="editUser.aspx.cs" Inherits="admin_editUser" %>
                    ...
                    <div class="panel-body">
                        <div class="flot-chart">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">          
                                <asp:TextBox ID="Name" runat="server" name="Name" placeholder="Name" class="form-control"></asp:TextBox>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Name" ErrorMessage="Enter your last name" CssClass="text-danger"></asp:RequiredFieldValidator>
                              </div>
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
